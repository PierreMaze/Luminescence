...
const PolitiqueConfidentialite = () => {
  return (
    <div className="w-full px-4 pt-12 sm:px-6 lg:px-14 2xl:mx-80">
      <section id="confidentialite" className="mt-20 ">
        <h5 className="text-sm">DERNIÈRE MISE À JOUR : 06-08-2024</h5>
        ...
        <p className="mb-4 ">
          <strong>Type de site : </strong>Site Vitrine
        </p>
        ...
        <ul className="flex flex-col gap-2 mb-4 list-decimal list-inside">
        ...
        <h3 className="mt-8 mb-2 text-xl font-semibold">Lois applicables</h3>
        <p className="mb-4">
          Conformément au Règlement général sur la protection des données
          (RGPD), cette politique de confidentialité est conforme aux règlements
          suivants.
        </p>
        <p className="mb-4">Les données à caractère personnel doivent être :</p>
        <ul className="flex flex-col gap-2 mb-4 list-decimal list-inside">
          <li>
          ...
          <li>
            ...
            exclusivement à des fins archivistiques dans l&apos;intérêt public,
        ...
        <h3 className="mt-8 mb-2 text-xl font-semibold">Consentement</h3>
        <p className="mb-4">
        ...
        <ul className="flex flex-col gap-2 mb-4 list-decimal list-inside">
          <li>Prénom et nom / Entreprise</li>
          <li>Email</li>
